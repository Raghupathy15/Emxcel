...
#     book = xlrd.open_workbook("hr_master_01.xlsx")
...
#         date_of_joining =  emp_sheet.cell(r,28).value
...
#         phone =  int(emp_sheet.cell(r,25).value)
...
# # def create_res_partner_bank():
# #     database = psycopg2.connect(host=HOST, user=USER, password=PSWD, database=DB, port=PORT)
# #     book = xlrd.open_workbook("hr_master_01.xlsx")
# #     cursor = database.cursor()
# #     emp_sheet = book.sheet_by_name("Sheet1")
# #     query = """SELECT acc_number from res_partner_bank where acc_number = '-'"""
# #     cursor.execute(query)
# #     select = cursor.fetchall()
# #     insert_bank = """INSERT INTO res_partner_bank (acc_number,partner_id) VALUES (%s,%s)"""
# #     cursor.execute(query)
# #     myresult = cursor.fetchall()
# #     acc_number = '-'
# #     partner_id = 1
# #     if not select:
# #         values = (acc_number,partner_id)
# #         cursor.execute(insert_bank, values)
# #     cursor.close()
# #     database.commit()
# #     database.close()
